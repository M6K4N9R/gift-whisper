  ...
  return (
    ...
    >
      <input
        ...
        className="w-full min-w-60 pl-4 pr-10 py-2 text-dark-accent-600 border rounded-md bg-dark-accent-100 focus:outline-none focus:ring-2 focus:ring-primary-900 focus:border-transparent"
      />
      <button
        type="submit"
